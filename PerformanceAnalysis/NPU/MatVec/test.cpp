 ...
 * Description: Test File for NPU Matrix-Vector Multiplication.
 */
...
int main(int argc, const char *argv[])
{
    ...
    constexpr unsigned ROWS_AMOUNT_A = 17408, COLUMNS_AMOUNT_A = 17056, ROWS_AMOUNT_B = COLUMNS_AMOUNT_A, COLUMNS_AMOUNT_B = 1;
    ...
    // Reshape Matrix A.
    ReshapeMatrix(buf_matrix_A, matrix_A, {1, 0,
                                                    n_aie_columns, ROWS_AMOUNT_A * COLUMNS_AMOUNT_A / n_aie_columns,
                                                    matrix_A_repeat, 0,
    ...
    // Define the amount of iterations.
    unsigned num_iter = n_evaluation_iterations + n_warmup_iterations;
    ...
    for (unsigned iter = 0; iter < num_iter; iter++)
    {
        ...
        ReshapeMatrix(buf_matrix_B, matrix_B, {1, 0,
                                                        ...
                                                        matrix_B_repeat, 0,
                                                        ROWS_AMOUNT_B / k, k * COLUMNS_AMOUNT_B,
                                                        n, 1,
                                                        k, COLUMNS_AMOUNT_B});
